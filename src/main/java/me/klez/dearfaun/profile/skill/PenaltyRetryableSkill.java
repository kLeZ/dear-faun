...
public final class PenaltyRetryableSkill extends RetryableSkill {
	private final int penalty;

	public PenaltyRetryableSkill(String name, AbilityScore abilityScore, int ranks, int[] misc, boolean trained, int penalty) {
